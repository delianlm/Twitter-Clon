...
//         <div class="tweet_line">
//           <div class="tweet_container">
//             <p class="error_message"> Nothing here...</p>
//           </div>
//         </div>
//         `
//         ;
...
// let newTweetText = ""
// const newTweetButton = document.querySelectorAll(".wh_twit_button");
// const newTweeTextArea = document.querySelectorAll(".write_tweet");
// const counter = document.querySelectorAll(".contador");
...
//     }
//   });
//   newTweeTextArea.addEventListener("keydown",() => {
//     newTweeTextArea = newTweeTextArea.value
//     checkTweetLengh()
//     counterTweets()
//   })
// }
...
// const showCounter = () => {
//   counter.classList.add("counter_visible")
// }

// const hideCounter = () => {
//   counter.classList.remove("counter_visible")
// }

// const checkTweetLengh = () => {
...
//   newTweetButton.classList.remove("wh_twit_button_visible")
// }
...
//  newTweetText = newTweeTextArea.value
//  const newTweet = {
//         user: {
...
//         }
//       }
//  data.dataItem.unshift(newTweet);
//  console.log(hola);
//  renderTweets()
// }
...
// const counterTweets = () => {
//   counter.innerHTML = 280 - newTweeTextArea.value.length
//   if (newTweeTextArea.value.length >= 260) {
